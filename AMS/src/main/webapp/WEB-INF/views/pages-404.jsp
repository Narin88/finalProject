...
<title>404 :: No.M University</title>
...
<body class="fixed-left">
	<!-- Begin page -->
	<div class="accountbg">
		<img src="resources/assets/images/noM_logo5.png"
			style="width: 100%; height: 1057px; margin: -14.5% 0 0 1.5%;">
	</div>
		...
		<div class="card" style="height: 300px;">
			<div class="card-block">
				...
				<div class="ex-page-content text-center">
					<h1 class="">404</h1>
					<h3 class="">죄송합니다, 홈페이지를 찾을수 없습니다.</h3>
