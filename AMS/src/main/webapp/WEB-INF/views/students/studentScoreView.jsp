...
// 그리드를 보여준다
	var grid = new tui.Grid({
		...
		,
		columns: [
			{header: '년도', name: 'lyear', width: 100},
			{header: '학기', name: 'term', width: 100},	<!-- 년도랑 학기가 같은 값일 때, 강의 개수 만큼 묶어서 출력해야 하는데. 어떡해야 하지? -->
			{header: '강의명', name: 'lname', width: 100},
			{header: '이수구분', name: 'division', width: 100},
			{header: '학점', name: 'credit', width: 200},
			{header: '총점', name: 'total', width: 200},
			{header: '등급', name: 'rank', width: 100}
